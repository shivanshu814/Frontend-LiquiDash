...
const defaultConfig = ({ appName = 'ConnectKit', appIcon, appDescription, appUrl, walletConnectProjectId, chains = [mainnet, polygon, optimism, arbitrum], client, ...props }) => {
    var _a, _b;
...
function useCoinbaseWalletUri({ enabled } = {
    ...
    useEffect(() => {
        ...
        async function handleMessage(message) {
            ...
            if (type === 'connecting') {
                const p = await connector.getProvider();
                if (p === null || p === void 0 ? void 0 : p.qrUrl)
                    setUri(p.qrUrl);
            }
        }
        async function handleDisconnect() {
...
const Web3ContextProvider = ({ enabled, children, }) => {
    ...
    const value = {
        connect: {
            getUri: (id) => {
                if (isCoinbaseWalletConnector(id))
...
const ChainSelectList = ({ variant, }) => {
    ...
    const pendingChainId = isPending ? data === null || data === void 0 ? void 0 : data.id : undefined;
