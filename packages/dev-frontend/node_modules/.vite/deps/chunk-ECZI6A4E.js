...
function getHttpRpcClient(url, options = {}) {
  return {
    async request(params) {
      var _a;
      const { body, fetchOptions = {}, timeout = options.timeout ?? 1e4 } = params;
...
async function getWebSocketRpcClient(url) {
  return getSocketRpcClient({
    async getSocket({ onResponse }) {
      const WebSocket = await import("./native-E7BDKKY2.js").then((module) => module.WebSocket);
...
// ../../node_modules/viem/_esm/types/rpc.js
...
// ../../node_modules/viem/_esm/types/contract.js
...
//# sourceMappingURL=chunk-ECZI6A4E.js.map
