...
const troveBeforeRedistribution = new Query_1.Query(client_1.gql `
    ...
    ${troveRawFields}
  `, ({ data: { user } }, { address }) => {
    if (user === null || user === void 0 ? void 0 : user.trove) {
...
class SubgraphLiquity {
    ...
    getUniTokenBalance(address) {
        throw new Error("Method not implemented.");
    }
    getUniTokenAllowance(address) {
        throw new Error("Method not implemented.");
    }
    getRemainingLiquidityMiningLQTYReward() {
        throw new Error("Method not implemented.");
    }
    getLiquidityMiningStake(address) {
        throw new Error("Method not implemented.");
    }
    getLiquidityMiningLQTYReward(address) {
        throw new Error("Method not implemented.");
    }
