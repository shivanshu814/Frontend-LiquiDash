...
export class TroveManager__getEntireDebtAndCollResult {
  ...
  getPendingLUSDDebtReward(): BigInt {
    return this.value2;
  }

  getPendingETHReward(): BigInt {
    return this.value3;
  }
}
...
export class TroveManager extends ethereum.SmartContract {
  ...
  Troves(param0: Address): TroveManager__TrovesResult {
    let result = super.call(
      "Troves",
  ...
  try_Troves(param0: Address): ethereum.CallResult<TroveManager__TrovesResult> {
    let result = super.tryCall(
      "Troves",
      "Troves(address):(uint256,uint256,uint256,uint8,uint128)",
      [ethereum.Value.fromAddress(param0)],
  ...
  rewardSnapshots(param0: Address): TroveManager__rewardSnapshotsResult {
    let result = super.call(
      "rewardSnapshots",
